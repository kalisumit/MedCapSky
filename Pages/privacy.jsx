...
function PrivacyPolicy() {
  return (
    <>
    <Navlink />
    <div className="max-w-[95%] mx-auto px-4 py-10 mt-[35px] text-gray-800">
      ...
      <section className="mb-8">
        ...
        <p className="mt-2 font-semibold text-green-700">We do <strong>not</strong> sell your data to any third party.</p>
      </section>
      ...
      <section>
        ...
        <p className="mt-2">
          <strong>MedCapSky Revolution Pvt. Ltd.</strong><br />
          📧 Email: <a href="mailto:privacy@medcapsky.com" className="text-blue-600 underline">privacy@medcapsky.com</a><br />
