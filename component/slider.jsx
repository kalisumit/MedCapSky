...
function Sliders(){
    ...
    return(
        <div className="md:w-3/4 mx-5 m-auto bg-gray-100 md:p-8 rounded-lg shadow-lg">
        <Slider {...settings}>
            {data.map((d) => (
...
const data = [
    {
        ...
        img: "src/assets/male_user_image-remove-1.png",
    ...
    },
    {
        ...
        img: "src/assets/female_user_image-removebg-previewf.png",
